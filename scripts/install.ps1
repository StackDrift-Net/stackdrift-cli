# Installs the StackDrift CLI on Windows into LOCALAPPDATA\StackDrift and puts
# that directory on the user's PATH. Everything it does is per user, so it needs
# no elevation. Run with:
